...
namespace CustomizableForms
{
    public partial class CustomizableForm : Form
    {
        ...
        [Category("DynamicForm"), Browsable(true), Description("DarkTheme")]
        ...
        [Category("DynamicForm"), Browsable(true), Description("Resizable")]
        ...
        [Category("DynamicForm"), Browsable(true), Description("BorderWidth")]
        ...
        [Category("DynamicForm"), Browsable(true), Description("BorderColor")]
        ...
        [Category("DynamicForm"), Browsable(true), Description("ShowTitle")]
